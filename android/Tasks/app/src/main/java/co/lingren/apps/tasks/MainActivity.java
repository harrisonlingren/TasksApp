...
public class MainActivity extends AppCompatActivity {
    ...
    private void addTask(String title, String notes) {
        // Get new key for object
        String newKey = ref.push().getKey();

        // Create task object and Map
        Task newTask = new Task(title, notes, newKey);
        Map<String, Object> taskValues = newTask.toMap();

        // Map values to HashMap for child update
        Map<String, Object> childUpdates = new HashMap<>();
        childUpdates.put("/tasks/" + newKey, taskValues);
